...
namespace PizzaPlace.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<PizzaPlaceRepository>();
            ...
            //services.AddMvc().AddScoped<PizzaPlaceRepository>;
            //services.AddDbContext<PizzaPlaceDbContext>(option => options.UseSqlServer(Configuration.GetConnectionString("PizzaPlaceDB")));
        }
