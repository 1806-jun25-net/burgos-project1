...
namespace PizzaPlace.Web.Controllers
{
    public class PizzasController : Controller
    {
        ...
        public async Task<IActionResult> ChoosePizza()
        {
        ...
        public async Task<IActionResult> Create([Bind("PizzaId,Name,Size,Price")] Pizza pizza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PizzaId,Name,Size,Price")] Pizza pizza)
        {
            if (id != pizza.PizzaId)
            {
                return NotFound();
